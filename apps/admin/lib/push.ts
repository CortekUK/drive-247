...
// Portal-specific key: the admin app, an operator portal and a customer
// booking app can all sit on the SAME phone; a shared device id would let one
// overwrite another's subscription row.
const DEVICE_ID_KEY = 'd247_admin_push_device_id';
