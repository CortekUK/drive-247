...
function functionBadgeColor(fn: string): string {
  if (fn === 'chat') return 'bg-[hsl(var(--chart-3))]/10 text-[hsl(var(--chart-3))] border-blue-500/20';
  ...
  if (fn === 'rag-init' || fn === 'rag-sync') return 'bg-warning/10 text-warning border-amber-500/20';
  if (fn.includes('ocr') || fn.includes('validate')) return 'bg-success/10 text-success border-emerald-500/20';
                ...
                {recentCalls.map((l) => (
                  <TableRow key={l.id}>
                    ...
                    <TableCell>
                      ...
                      {l.is_fallback && (
                        <Badge variant="outline" className="ml-1 text-[10px] bg-warning/10 text-warning border-amber-500/20">
                          fallback
                        </Badge>
                      )}
                    </TableCell>
