import { applyWebsiteVisibility } from '@nw/lib/vehicles/availability-rules';
/**
...
import { VEHICLE_PHOTO_COLUMNS, vehiclePublicColumns } from '@nw/lib/domain';
import type { PublicVehicleRowWithPhotos } from '@nw/lib/vehicles/types';
