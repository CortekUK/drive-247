import { ShieldCheck } from "lucide-react-nw";
import Image from "next/image";

import {
  ReadinessCard,
  type ReadinessVehicle,
} from "@nw/components/cards/readiness-card";
import { loadFleetSeed } from "@nw/components/fleet/fleet-seed";
import { LocationSearchForm } from "@nw/components/forms/location-search-form";
import { DEFAULT_HOME_HERO } from "@nw/lib/cms/defaults";
import { getTenantSlug, isEditMode, loadSection } from "@nw/lib/cms/server";
import { Editable, cmsImage, cmsSection } from "@nw/lib/cms/editable";
...
export async function HeroSection() {
  ...
  */
  ...
  return (
    <section {...cmsSection("home.home_hero", "Hero")} className="relative overflow-hidden bg-brand-cream">
