import type { LucideIcon } from "lucide-react-nw";
import Image from "next/image";

import { cn } from "@nw/lib/utils";
import { Editable, cmsImage } from "@nw/lib/cms/editable";

type FeatureCardProps = {
  title: string;
  description: string;
  /**
   * Where this card's copy lives in the CMS, e.g. `about.why_choose_us.items.2`.
   * When set, the title and description are marked for the portal's visual
   * editor (see lib/cms/editable.tsx). Absent for cards that are not CMS-bound.
   */
  cmsPath?: string;
  icon?: LucideIcon;
