...
import { XIcon } from "lucide-react-nw"
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-4 right-4 inline-flex size-8 items-center justify-center rounded-full text-brand-text-subtle transition-colors outline-none hover:bg-brand-stone hover:text-brand-text focus-visible:ring-[3px] focus-visible:ring-brand-forest/25 disabled:pointer-events-none"
          >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "text-lg leading-tight font-semibold tracking-tight text-brand-text",
        className
      )}
      {...props}
    />
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-sm leading-relaxed text-brand-text-soft", className)}
      {...props}
    />
  )
}
