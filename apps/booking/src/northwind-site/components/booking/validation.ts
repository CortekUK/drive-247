...
import { calendarDaysBetween } from "@nw/lib/domain";
import type { BookingFormState } from "@nw/lib/stores/booking-store";
import type { UnavailableReason, Vehicle } from "@nw/lib/vehicles/types";
