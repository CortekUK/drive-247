...
import { formatDateOnly, parseDateOnly, todayDateString } from '@nw/lib/domain';
import type { UnavailableReason } from '@nw/lib/vehicles/types';
 ...
 */
export { OPEN_RENTAL_STATUSES } from '@nw/lib/vehicles/availability-rules';
import { OPEN_RENTAL_STATUSES, RELEASED_RENTAL_STATUSES, OUT_NOW_STATUSES, rentalOccupiesWindow as occupiesWindow, bufferOccupiesPickup, type OccupancyRental } from '@nw/lib/vehicles/availability-rules';
export type { OccupancyRental } from '@nw/lib/vehicles/availability-rules';
