...
const MultiStepBookingWidget = () => {
  ...
  useEffect(() => {
    ...
    // Handle window focus - re-check verification when the user returns to this tab
    // (e.g. after finishing the ID capture on their phone).
        ...
        {currentStep === 4 && <div className="space-y-8">
          ...
          <div className="space-y-8">
            ...
            <div className="border-t border-border/50 pt-6 sm:pt-8">
              ...
              {verificationStatus === 'pending' && aiSessionData && (
                <AIVerificationQR
