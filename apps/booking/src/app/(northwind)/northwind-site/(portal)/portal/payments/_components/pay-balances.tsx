...
import { ArrowRight, CreditCard, Loader2, TriangleAlert } from 'lucide-react-nw';
import { toast } from 'sonner-nw';

import {
  PaymentPanel,
  type PaymentPanelCopy,
} from '@nw/components/booking/payment-panel';
...
import type { BookingPaymentIntentResponse } from '@nw/hooks/use-payment-intent';
import { formatDate, relativeDayLabel } from '@nw/components/portal/format';
import { Panel, PanelHeader } from '@nw/components/portal/primitives';
...
import type { PayableBalance } from '@nw/hooks/use-customer-payments';
import { useTenantBranding } from '@nw/hooks/use-tenant-branding';
import {
  createBalancePaymentIntent,
  type BalanceIntentFailure,
} from '@nw/lib/stripe/create-balance-payment-intent';
