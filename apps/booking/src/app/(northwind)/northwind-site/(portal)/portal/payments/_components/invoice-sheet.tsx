...
import { ArrowRight, FileText } from 'lucide-react-nw';

import { formatDate } from '@nw/components/portal/format';
...
import type { CustomerInvoice } from '@nw/hooks/use-customer-payments';
