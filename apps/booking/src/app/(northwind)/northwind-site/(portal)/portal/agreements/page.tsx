...
import { FileSignature, RefreshCw } from 'lucide-react-nw';
...
import { useCustomerAgreements } from '@nw/hooks/use-customer-agreements';
import { useCustomerRentals } from '@nw/hooks/use-customer-rentals';
