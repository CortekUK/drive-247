import { Footer } from "@nw/components/layout/footer";
import { Navbar } from "@nw/components/layout/navbar";
import { loadBlogEnabled, loadPageSections, resolveTenant } from "@nw/lib/cms/server";
