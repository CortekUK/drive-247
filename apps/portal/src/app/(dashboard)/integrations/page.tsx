...
// ── Integrations page — official logos via logo.dev (Bonzah uses local SVG) ──
//
...
import { Globe, IdentificationCard } from "@phosphor-icons/react";
...
const integrations: Integration[] = [
  ...
  { name: "CheckMyDriver", category: "Verification", description: "Verify driver's licenses & identity.", connected: false, Icon: IdentificationCard, iconColor: "#0EA5E9" },
