  ...
  return (
    <button
      ...
      className={cn(
        ...
        active ? "border-primary/40 bg-primary/5" : "border-border hover:border-primary/30 hover:bg-primary/5 dark:hover:border-indigo-300/30 dark:hover:bg-[hsl(var(--v2-hover,var(--muted)))]",
      )}
    >
