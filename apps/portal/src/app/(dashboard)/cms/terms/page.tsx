...
export default function CMSTermsEditor() {
  ...
  const handleResetToDefaults = async () => {
    setIsResetting(true);
    try {
      const defaults = CMS_DEFAULTS.terms;
      await Promise.all([
        updateSection({ sectionKey: "terms_content", content: defaults }),
    ...
    return (
      <div className="space-y-6 p-4 md:p-6">
        ...
        <EmptyState
          ...
          title="Terms of Service page not found in CMS"
          description='Please ensure the "terms" page is set up in the database.'
        />
      </div>
    );
  }
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will replace all Terms of Service content with Drive 917 default content.
