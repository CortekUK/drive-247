...
export default function InsurancesList() {
  ...
  //
  // The lean gate is ANDed in here rather than at each render site on purpose:
  // this one flag drives the coverage query, the error banner, the "INSHUR Only"
  // provider chip and — because the rows themselves come from that query — every
