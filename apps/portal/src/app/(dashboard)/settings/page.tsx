...
const Settings = () => {
  ...
  // Fleet Health was parked on 2026-09-03: app/(dashboard)/fleet-health/page.tsx
  // no longer exists. The self-service toggle that used to live here went with it —
  // leaving it would have let any of the 57 tenants switch on a nav entry pointing
  // at a 404, and its success toast said "added to your sidebar".
  // tenants.fleet_health_enabled is deliberately untouched and both sidebars still
  // read it, so restoring the route restores the entry. Branch: park/fleet-health
