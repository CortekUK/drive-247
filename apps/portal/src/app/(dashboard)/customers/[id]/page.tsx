...
const CustomerDetail = () => {
  ...
  // Belt and braces: the hook already refuses to fetch for a lean tenant, but
  // this second gate means a cached row from a previous session still cannot
  // light up the CMD tab.
  const hasCmd = !!cmdVerification && !cmdHidden;
