...
// MOCK fallback vehicles so the step always renders something to preview.
const MOCK_VEHICLES: VehicleLite[] = [
  { id: "v1", make: "Tesla", model: "Model 3", reg: "DRV-1042", status: "Available", daily_rent: 89, weekly_rent: 520, monthly_rent: 1900, security_deposit: 300, daily_mileage: 150 },
  { id: "v2", make: "Toyota", model: "Camry", reg: "DRV-2271", status: "Available", daily_rent: 55, weekly_rent: 330, monthly_rent: 1200, security_deposit: 200, daily_mileage: 150 },
  { id: "v3", make: "Ford", model: "Mustang", reg: "DRV-3380", status: "Rented", daily_rent: 120, weekly_rent: 720, monthly_rent: 2600, security_deposit: 500, daily_mileage: 100 },
  { id: "v4", make: "Honda", model: "Civic", reg: "DRV-4119", status: "Available", daily_rent: 49, weekly_rent: 300, monthly_rent: 1100, security_deposit: 200, daily_mileage: 150 },
  { id: "v5", make: "BMW", model: "X5", reg: "DRV-5503", status: "Available", daily_rent: 140, weekly_rent: 840, monthly_rent: 3000, security_deposit: 600, daily_mileage: 120 },
];
...
export function VehicleList({ selected, onSelect, vehicles, currency = "$" }: VehicleListProps) {
  const data = vehicles && vehicles.length > 0 ? vehicles : MOCK_VEHICLES;
