...
import { Loader2, Save, Calendar, Plus, X } from "lucide-react";
import type { BookingHeaderContent } from "@/types/cms";

interface BookingHeaderEditorProps {
  content: BookingHeaderContent;
  onSave: (content: BookingHeaderContent) => void;
  isSaving: boolean;
}
...
export function BookingHeaderEditor({ content, onSave, isSaving }: BookingHeaderEditorProps) {
      ...
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              The header text above the booking form
            </CardDescription>
          </CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Book Your Rental" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Small trust indicators shown below the subtitle</p>
                </div>
