...
const buttonVariants = cva(
  ...
  // `button { cursor: default }`, undoing the browser's own pointer. Every
  // button in the portal has shown an arrow since the v3→v4 upgrade. Nothing
  // visual changes here — `disabled:pointer-events-none` already suppresses the
