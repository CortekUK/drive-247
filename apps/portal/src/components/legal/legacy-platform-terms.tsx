...
/**
 * The PREVIOUS Drive247 platform terms — the document that is live today.
 *
 * Lifted verbatim out of (auth)/terms/page.tsx when that page became a switch
 * between this and the Appendix A rewrite. Not a rewrite, not a summary: it is
 * the exact text tenants have been agreeing to, and it stays byte-identical so
 * that acceptances already stamped as "2026-02-legacy" keep pointing at
 * something we can actually reproduce.
 *
 * It is served while PLATFORM_TOS_IS_DRAFT is true (see lib/legal/platform-tos.ts).
 * Once the solicitor signs off and that flips, this component stops rendering —
 * but do NOT delete it: it is the only record of what the earlier version said.
 */

import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";

export function LegacyPlatformTerms() {
  return (
