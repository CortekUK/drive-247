...
interface AddProtectionPlanDialogProps {
  open: boolean;
...
export const AddProtectionPlanDialog = ({ open, onOpenChange }: AddProtectionPlanDialogProps) => {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Protection plan created successfully");
      onOpenChange(false);
      resetForm();
    },
    onError: (error: any) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new protection/insurance plan for rentals
          </DialogDescription>
        </DialogHeader>
