...
export const RentalCreateV2 = () => {
  ...
  const onSubmit = async (data: RentalFormData) => {
    ...
    try {
      ...
      // Additional drivers: bulk-insert rows + fire-and-forget AI verification invites.
                ...
                <div className="rounded-xl border bg-card shadow-sm">
                  ...
                  <div className="p-5 space-y-4">
                    <RadioGroup
                      ...
                      className="space-y-2"
                    >
                      <label className={cn("flex items-center gap-3 rounded-lg border p-3 cursor-pointer transition-colors", !isPayAsYouGo ? "border-primary bg-primary/5" : "hover:border-primary/40 hover:bg-primary/5")}>
                      ...
                      {(rentalSettings as any)?.auto_extend_enabled && (
                        <label className={cn("flex items-center gap-3 rounded-lg border p-3 cursor-pointer transition-colors", isAutoExtend ? "border-primary bg-primary/5" : "hover:border-primary/40 hover:bg-primary/5")}>
                          ...
                          return (
                            <label
                              ...
                              className={cn(
                                ...
                                installmentPlanType === plan.type ? "border-primary bg-primary/5" : "hover:border-primary/40 hover:bg-primary/5"
                              )}
                            >
                  ...
                  {rentalSettings?.lockbox_enabled && (
                    <div className="border-t pt-4">
                      ...
                      <RadioGroup value={deliveryMethod} onValueChange={(val) => setDeliveryMethod(val as 'in_person' | 'lockbox')} className="flex gap-4">
                        <label className={cn("flex items-center gap-2.5 rounded-lg border p-3 flex-1 cursor-pointer transition-colors", deliveryMethod === 'in_person' ? "border-primary bg-primary/5" : "hover:border-primary/40 hover:bg-primary/5")}>
                        ...
                        <label className={cn("flex items-center gap-2.5 rounded-lg border p-3 flex-1 cursor-pointer transition-colors", deliveryMethod === 'lockbox' ? "border-primary bg-primary/5" : "hover:border-primary/40 hover:bg-primary/5")}>
        ...
        <AlertDialogContent>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              rows={3}
              placeholder="e.g. Passport and driving licence checked in person at the branch on 9 Aug; AI verification repeatedly failed on document scan."
            />
            <p className="text-xs text-muted-foreground">
        ...
        <AlertDialogContent className="max-w-lg">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              rows={3}
              placeholder="e.g. Long-standing corporate account, ID held on file at head office; AI verification unavailable and customer collecting today."
            />
