...
function AlertDialogDescription({
  ...
  return (
    <AlertDialogPrimitive.Description
      ...
      className={cn(
        "text-sm text-balance text-muted-foreground md:text-pretty [&>a]:underline [&>a]:underline-offset-[3px] [&>a:hover]:text-foreground",
        className
      )}
      {...props}
    />
