    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          // near-black; so the panel sets its own violet wash (violet-500/30)
          // and makes the highlighted label its own ivory.
                                  tone === "dark" ? "dark bg-popover/70 [--v2-hover:258_90%_66%_/_0.3] [--accent-foreground:var(--popover-foreground)]" : "border border-border bg-popover",
