/**
 * Notifications v2: how a push notification looks on a phone.
 *
 * The push preview (components/settings-v2/notifications-v2/push-preview-phone.tsx)
 * draws an iPhone lock-screen card and an Android notification-shade card at
 * the sizes below and clamps the text with CSS `line-clamp`, so the "…" falls
 * roughly where the phone puts it (build-spec D16, transcript §3.9).
 *
