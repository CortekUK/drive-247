...
export const EMAIL_TEMPLATE_VARIABLES: EmailTemplateVariable[] = [
  ...
  {
    key: 'vehicle_reg_row',
    label: 'Registration Table Row',
    description: 'A complete "Registration" table row, or nothing at all when the tenant has chosen to hide vehicle registrations. Use this inside a <table> instead of writing the row yourself, so a withheld plate leaves no empty row behind.',
    sample: '  <tr>\n    <td><strong>Registration:</strong></td>\n    <td>ABC 123</td>\n  </tr>',
    category: 'vehicle',
  },
  {
    key: 'vehicle_reg_suffix',
    label: 'Registration Suffix',
    description: 'The plate in brackets, e.g. " (ABC 123)", or nothing at all when the tenant has chosen to hide vehicle registrations. Append it to the vehicle name instead of writing your own brackets, which would otherwise be left empty.',
    sample: ' (ABC 123)',
    category: 'vehicle',
  },
  {
  ...
  // PAYG-specific variables (used by payg_reminder template)
  {
    key: 'outstanding_amount',
    label: 'Outstanding Amount',
    description: 'Total unpaid balance on the PAYG rental at send time',
    sample: '$1,992.85',
    category: 'email',
  },
  {
    key: 'days_active',
    label: 'Days Active',
    description: 'How many days the PAYG rental has been running',
    sample: '5',
    category: 'email',
  },
  {
    ...
    description: 'The PAYG daily invoice reference, e.g. pg-001',
    sample: 'pg-005',
    category: 'email',
  },
  {
...
export const EMAIL_TEMPLATE_TYPES: EmailTemplateType[] = [
  {
    ...
    availableVariables: ['customer_name', 'customer_email', 'vehicle_make', 'vehicle_model', 'vehicle_reg', 'vehicle_reg_row', 'rental_number', 'rental_start_date', 'rental_end_date', 'rental_amount', 'company_name', 'company_email', 'company_phone'],
  },
  {
    key: 'booking_documents_required',
    name: 'Booking Documents Required',
    description: 'Sent automatically once payment has settled, asking the customer to upload their driving licence and a selfie. Payment is taken at this point but the booking is NOT confirmed — confirmation is Booking Approved.',
    defaultSubject: 'Action needed: upload your documents for {{rental_number}}',
    availableVariables: ['customer_name', 'customer_email', 'vehicle_make', 'vehicle_model', 'vehicle_reg', 'vehicle_reg_row', 'rental_number', 'rental_start_date', 'rental_end_date', 'rental_amount', 'verification_url', 'company_name', 'company_email', 'company_phone'],
  },
  {
    key: 'booking_documents_received',
    name: 'Booking Documents Received',
    description: 'Sent once the customer has uploaded their documents. Acknowledges receipt and says the booking is under review — it must not read as a confirmation, because the booking can still be rejected.',
    defaultSubject: 'Documents received for {{rental_number}}',
    availableVariables: ['customer_name', 'customer_email', 'vehicle_make', 'vehicle_model', 'vehicle_reg', 'vehicle_reg_row', 'rental_number', 'rental_start_date', 'rental_end_date', 'rental_amount', 'company_name', 'company_email', 'company_phone'],
  },
  {
  ...
  },
  {
    ...
    availableVariables: ['customer_name', 'customer_email', 'vehicle_make', 'vehicle_model', 'vehicle_reg', 'vehicle_reg_suffix', 'rental_number', 'rental_start_date', 'rental_end_date', 'company_name', 'company_email', 'company_phone'],
  },
  {
    key: 'rental_started',
    name: 'Rental Started',
    ...
    availableVariables: ['customer_name', 'customer_email', 'vehicle_make', 'vehicle_model', 'vehicle_reg', 'vehicle_reg_row', 'rental_number', 'rental_start_date', 'rental_end_date', 'company_name', 'company_email', 'company_phone'],
  },
  {
    key: 'rental_reminder',
    ...
    availableVariables: ['customer_name', 'customer_email', 'vehicle_make', 'vehicle_model', 'vehicle_reg', 'vehicle_reg_suffix', 'rental_number', 'payment_amount', 'due_date', 'company_name', 'company_email', 'company_phone'],
  },
  {
  ...
  },
  {
    ...
    defaultSubject: 'Return Reminder - {{rental_number}}',
    availableVariables: ['customer_name', 'customer_email', 'vehicle_make', 'vehicle_model', 'vehicle_reg', 'vehicle_reg_row', 'rental_number', 'rental_end_date', 'due_date', 'company_name', 'company_email', 'company_phone'],
  },
  {
    key: 'payment_failed',
    name: 'Payment Failed',
