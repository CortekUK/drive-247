...
//
// components/rentals-v2/rental-detail/stage-payments.tsx exactly as it stood
// at commit 61f877d1, before the Finances-canary balance section, fines and
// billed/received views were placed in it. Only its relative imports are
// rewritten to absolute ones so it can live here. balance-canary-placement
// .test.tsx renders this and today's StagePayments for a non-canary tenant
// and requires identical HTML.
/* eslint-disable */
"use client";
...
import { SHOW_MULTI_PERIOD } from "@/components/rentals-v2/rental-detail/multi-period";
import { useRentalTotals } from "@/hooks/use-rental-ledger-data";
import type { StageProps } from "@/components/rentals-v2/rental-detail/stages";
import { EmptyHint, Panel, cardCls, fmtDateTime } from "@/components/rentals-v2/rental-detail/_kit";
import {
  counts,
  day,
  heldOn,
...
import { PaymentActions, type ActionRequest } from "@/components/rentals-v2/rental-detail/payments-actions";
...
export function StagePaymentsAtHead({ detail, refetch }: StageProps) {
