...
//
// components/customers-v2/customer-detail/section-money.tsx exactly as it stood
// at commit 61f877d1, before the Finances-canary balance header was placed in
// it. Only its three relative imports are rewritten to absolute ones so it can
// live here. balance-canary-placement.test.tsx renders this and today's
// SectionMoney for a non-canary tenant and requires identical HTML.
/* eslint-disable */
"use client";
...
import { ledgerTotals, moneyIn, signedMoney } from "@/components/customers-v2/customer-detail/derive";
import { EmptyHint, Panel, Pill, ProducedFrom, Section, Stat, cardCls, fmtDate, listCls } from "@/components/customers-v2/customer-detail/kit";
import type { SectionProps } from "@/components/customers-v2/customer-detail/sections";

export function SectionMoneyAtHead({ c, onJump, canEdit, currency }: SectionProps) {
