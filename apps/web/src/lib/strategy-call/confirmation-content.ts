...
export const CONFIRMATION_VIDEOS = [
  {
    ...
    transcript: [
      ...
      "That move alone recovered $18 ,000 in fees. Same cars, same demand. He just stopped renting his own business back from our platform.",
      "Now you're probably thinking it sounds too good in theory, but is it real? Is it actually built or is it just sides? And I promise. I mean, very fair question.",
  ...
  },
  {
    ...
    transcript: [
      "So you've already seen those last few videos so pretty much so I just want to run through like a short demo with you of the actual site and the back office so when we actually jump on the call you have everything that you need in order to get rocking and rolling. So pretty much I'm just going to briefly go over RevTech rentals here for you guys this is one of our existing clients they've been with us for the last six months and I want to show off these guys' size because",
      "one it looks absolutely amazing but two because they've done something good job in configuring everything exactly how they want to run their business which is the whole point of Drive247 right taking control back for your business. So obviously here is their existing system so this is their site with their logo their name, their about you page, their fleet and pricing, reviews, promotions, FAQs, contacts and blogs. Okay absolutely everything has been custom built out and",
      "personalized for them on this site which means they have a brand they have their own solid site which means when the custom boots and there's more trust built out.",
      ...
      "uploaded process it all with the AI built -in and it's going to verify everything for you once they get the green light they can then review and confirm automatically you get a rental agreement sent over to their email for ready for an e -signature you get a rental invoice generated for them and they also get a rental summary as well this you don't have to touch it's already done for you to save you going to another software save you having to fap",
      "about and do it yourself once that's all done everything is ready to be paid just simple stripe check out once they pay everything the whole flow is completed you haven't even had to touch the thing to get the customer rented in and then you can see everything on the backup it's here so this is one of our demo accounts actually which is why there is really isn't much business activity going on here but there's a full proprietary AI built out into the system which can do actions",
  ...
  },
  {
    ...
    transcript: [
      ...
      "Right. And you complete them. Nothing about this is shutting off your marketplace bookings.",
      ...
      "We say seven days, and that's done with you. Not dumped on you. Keep it cool, then within an hour your system and your dashboard is live and your branded site is ready to review. About a week in payments verification are all connected and you're taking direct bookings.",
      ...
      "booking on our own site than a marketplace listing. And Marcus, did I even mention, recovered 18 grand in four months. The question is whether you can afford this. It's whether you can afford to keep handing over a third of every single booking.",
      "Will customers actually book on my site instead of a marketplace they already trust?",
      "This surprises people. Trust transfers. When someone lands on a clean branded site with real time availability, insurance and ID handle that checkout, a proper booking flow, they trust you more. But Lex, you stop looking like a listing and start looking more like a real rental business.",
      "Because you are. Here's the honest part. This isn't for everyone. You've got one car and you're starting out. This is too much system for you right now. This is built for operators who are already doing a real volume, four, five or more. Already taken bookings, who are ready to stop being dependent on a platform they couldn't control. If that's you, the last video shows you exactly what happens next and how to get your own direct site mapped out.",
      "Go watch it now.",
    ],
  },
  {
    ...
    transcript: [
      "Alright, let me be straight with you exactly who this call is for. Alright, so for operators who run 4 or 5 more vehicles who are already taking bookings and who are done being fully dependent on marketplaces. Alright, if you're just getting started, this probably isn't the right fit just yet and that's totally okay. But if you are an established operator, maybe a Turo Power Host or an airport or local fleet, someone who's ready to own their customers and their",
      "pricing, then just keep listening. Because here's exactly what the call is, it's round about 45 minutes, it's not a hard pitch and on the call will look at your fleet and your pricing, will map out your direct channel and will actually mock up a branded booking site that you could look like.",
      ...
      "Just a bulk. With those we can give you real numbers instead of a generic kind of advice.",
      "The button below, this is the booking, grab all the time that works, but also just show up on a laptop, professional in a good environment and we'll go through absolutely everything.",
      "Right, how we can actually turn your marketplaces into direct bookings like yourself.",
      "So just some irritates, just confirm the times that it works that you booked in and show up and we'll be all sorted.",
    ],
  },
