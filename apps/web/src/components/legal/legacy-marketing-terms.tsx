/**
 * The PREVIOUS Drive247 marketing-site terms — the document live at
 * drive-247.com/terms today.
 *
 * Lifted verbatim out of (marketing)/terms/page.tsx when that page became a
 * switch between this and the Appendix A rewrite. Byte-identical on purpose:
 * it is the text tenants have actually been able to read, and
 * PLATFORM_TOS_VERSION currently identifies it.
 *
 * Served while PLATFORM_TOS_IS_DRAFT is true. Once the solicitor signs off and
 * that flips, this stops rendering — but do NOT delete it, it is the record of
 * what the earlier version said.
 */

export function LegacyMarketingTerms() {
  return (
