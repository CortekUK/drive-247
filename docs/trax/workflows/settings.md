...
- `apps/portal/src/components/settings-v2/settings-index.tsx`: SETTINGS_INDEX_SECTIONS (V2 settings index; **Customer messages** opens the templates tab).
