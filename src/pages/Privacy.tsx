...
import { usePageContent, defaultPrivacyContent, mergeWithDefaults } from "@/hooks/usePageContent";

const Privacy = () => {
  const { data: rawContent, isLoading } = usePageContent("privacy");
  const content = mergeWithDefaults(rawContent, defaultPrivacyContent);
  const privacyContent = content.privacy_content!;
