...
export function getRedirectUri(provider: "xero"): string {
  const explicit = Deno.env.get("XERO_REDIRECT_URI");
...
export function defaultRedirectBack(provider: "xero"): string {
