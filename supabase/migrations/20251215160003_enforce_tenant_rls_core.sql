-- ============================================
-- TENANT ROW LEVEL SECURITY (RLS) POLICIES - CORE TABLES ONLY
-- ============================================
-- This migration enforces strict tenant isolation across core tables
-- Only includes tables that are confirmed to exist
