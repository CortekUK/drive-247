-- ============================================================================
-- Migration: Fix both block_customer and unblock_customer functions
-- Date: 2026-01-19
-- Description: Fix 'user_id' to 'auth_user_id' in both functions and ensure
--              proper NULL handling in unblock logic
-- ============================================================================

-- Fix block_customer function
...
BEGIN
  -- Get the caller's tenant_id from app_users (FIXED: use auth_user_id not user_id)
