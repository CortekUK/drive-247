-- ============================================
-- TENANT ROW LEVEL SECURITY (RLS) POLICIES - ESSENTIAL TABLES ONLY
-- ============================================
-- This migration enforces strict tenant isolation
-- Only includes the core essential tables

-- Enable RLS on essential tenant-scoped tables
