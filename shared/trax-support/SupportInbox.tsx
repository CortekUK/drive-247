...
export function SupportInbox({call,admin=false,initialId,compose,scope,onCancel}:{call:MessagingCall;admin?:boolean;initialId?:string;compose?:SupportCompose;scope:string;onCancel?:()=>void}){
  ...
  return <div className="flex min-h-0 flex-1 flex-col text-foreground" data-testid="support-inbox">
    ...
    <div className="flex min-h-0 flex-1 flex-col md:flex-row">
      {!creating&&<aside className={(id?'hidden md:flex ':'flex ')+(admin?'md:w-80 ':'md:w-64 ')+'min-h-0 shrink-0 flex-col border-r border-border'}>
