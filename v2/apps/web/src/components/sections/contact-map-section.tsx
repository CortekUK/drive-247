    ...
    <section className="bg-brand-cream">
      <div className="container-page pb-12">
        <div className="relative overflow-hidden rounded-[16px] ring-1 ring-brand-border">
          ...
          <article className="pointer-events-auto absolute left-4 top-4 w-[280px] rounded-[12px] bg-white p-3 shadow-[0_12px_24px_-8px_rgba(0,0,0,0.18)] ring-1 ring-brand-border-soft sm:left-8 sm:top-8 sm:w-[320px]">
