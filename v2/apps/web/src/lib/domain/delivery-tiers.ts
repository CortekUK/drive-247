 ...
 *
 * Keep this file dependency-free so booking, portal and v2/apps/web can each
 * keep their own copy. Three copies exist:
 *   apps/booking/src/lib/delivery-tiers.ts        (v1, customer)
 *   apps/portal/src/lib/delivery-tiers.ts         (v1, staff)
 *   v2/apps/web/src/lib/domain/delivery-tiers.ts  (v2, customer)
